...
function DiceRoller({numDice=2,result}) {
  ...
  return (
    <div className='flex flex-col w-full gap-y-4 justify-center align-center'>
    ...
    <div className={sum===result?'text-center bg-green-500 p-4 rounded-lg text-2xl font-semibold':'bg-black bg-opacity-40 p-4 rounded-lg text-2xl font-semibold'}>{
