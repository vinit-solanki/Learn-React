...
export default function MyApp() {
  ...
  return (
    <div className='min-h-screen w-full p-4 text-center flex flex-col justify-center items-center align-center'>
      ...
      <div className='gap-x-3 w-full  grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3'>
        <div className='w-full bg-white bg-opacity-30 m-2 rounded-lg p-4 flex flex-col justify-center items-center gap-y-2 border-2 border-gray-300 shadow-md hover:shadow-blue'>
